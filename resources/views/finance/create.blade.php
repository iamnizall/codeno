                ...
                <form method="POST" action="{{ route('invoice.store') }}">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col">
                            ...
                            <input id="no_inv" type="text" class="form-control" name="no_inv" readonly
                                value="{{ $hs }}">
                        </div>
                        {{-- s_code --}}
                        <div class="col">
                            <label for="s_code">Swift Code</label>
                            <input id="s_code" type="text" class="form-control" name="s_code" value="{{ $scode }}"
                                readonly>
                        </div>
                        {{-- date --}}
                        <div class="col">
                    ...
                    <div class="form-row mt-4">
                        ...
                        <div class="col">
                            ...
                            <input id="no_po" type="text" class="form-control" name="no_po" value="{{ $hs }}"
                                readonly>
                        </div>
                        {{-- address --}}
                        <div class="col">
                    ...
                    <div class="form-row mt-4">
                        ...
                        <div class="col">
                            ...
                            <input id="client" type="text"
                                class="form-control{{ $errors->has('client') ? ' is-invalid' : '' }}" name="client"
                                value="{{ old('client') }}">
                        ...
                        <div class="col">
                            ...
                            <input id="payment" type="text"
                                class="form-control{{ $errors->has('payment') ? ' is-invalid' : '' }}" name="payment"
                                value="{{ old('payment') }}">
                        ...
                        <div class="card-body">
                            <div class="form-row mt">
                                ...
                                <div class="col">
                                    ...
                                    <input id="job_desc" type="text"
                                        class="form-control{{ $errors->has('job_desc') ? ' is-invalid' : '' }}"
                                        name="job_desc" value="{{ old('job_desc') }}">
                                ...
                                <div class="col">
                                    ...
                                    <input id="vol" type="text"
                                        class="form-control{{ $errors->has('vol') ? ' is-invalid' : '' }}" name="vol"
                                        value="{{ old('vol') }}">
                    ...
                    <div class="row mt-4">
                        <div class="col">
                            ...
                            <div class="text-center mt-4">
                                <button class="btn btn-success mx-3" style="width: 150px;" type="submit"><i
                        ...
                        <div class="col">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="cost" readonly class="form-control-plaintext stotal"
                                            value="0">
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="fax" readonly class="form-control-plaintext stotal"
                                            value="0">
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="stotal" id="stotal" readonly
                                            class="form-control-plaintext stotal" value="0">
                                    </div>
                                </div>
                                <hr>
